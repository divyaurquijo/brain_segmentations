...
@component(
    base_image="gcr.io/ataxia-rd-dev-358f/deploy_vnet:latest",
...
def deploy(
    ...
    destination_file = os.path.join(deploy_params.deploy_path, "brain_mri_vnet.pt")
    ...
    model_upload = aiplatform.Model.upload(
        ...
        description="Instance Segmentation on Brain MRI with VNET Pipeline",
